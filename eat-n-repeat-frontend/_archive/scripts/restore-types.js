...
const typesContent = `export type NotificationType = "low_stock" | "new_order" | "system" | "order_cancelled" | "payment_verified";
...
fs.writeFileSync('c:\\Eat n RepEat Cafe\\eat-n-repeat-frontend\\lib\\admin\\types.ts', typesContent);
console.log('Restored fully updated types.ts from model context memory!');
